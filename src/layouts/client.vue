                ...
                <ul class="p-5 list-reset text-grey-dark">
                    ...
                    <li class="pt-4 text-xs">
                        ...
                        <ul class="list-reset text-sm text-grey">
                            ...
                            <li>
                                <i class="fas fa-piggy-bank text-xs mr-1"></i>
                                Ordini
                            </li>
                        </ul>
                    </li>
                    <li class="pt-4 text-xs">
                        ...
                        <ul class="list-reset text-sm text-grey">
                            ...
                            <li>
                                <i class="fab fa-creative-commons-nc-eu text-xs mr-1"></i>
                                Note credito
                            </li>
                        </ul>
                    </li>
                    <li class="pt-4 text-xs">
                        ...
                        <ul class="list-reset text-sm text-grey">
                            <li>
                                <i class="fas fa-people-carry text-xs mr-1"></i>
                                DDT
                            </li>
                            <li>
                                <i class="fas fa-warehouse text-xs mr-1"></i>
                                Giacenze
                            </li>
                        </ul>
                    </li>
